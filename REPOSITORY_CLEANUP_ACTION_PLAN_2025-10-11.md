...
git add apps/dashboard/TESTING-KNOWN-ISSUES.md
git add apps/dashboard/TSCONFIG_FIXES_2025.md
...
- Known issues documentation: TESTING-KNOWN-ISSUES.md
- TypeScript fixes documentation: TSCONFIG_FIXES_2025.md
