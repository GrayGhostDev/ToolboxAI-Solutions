...
class CleanupAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[AgentConfig] = None):
        ...
        self.cleanup_patterns = {
            "temp_files": ["*.tmp", "*.temp", "~*", ".~*"],
            "cache_files": ["__pycache__", "*.pyc", "*.pyo", ".pytest_cache", ".coverage"],
            "log_files": ["*.log", "logs/*.log"],
            "build_artifacts": ["dist/", "build/", "*.egg-info"],
            "test_artifacts": ["htmlcov/", "coverage.xml", ".coverage*", "test-results/"],
...
"""
    ...
    async def _find_and_remove_duplicates(self, target_path: str, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _remove_empty_directories(self, target_path: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """Remove empty directories"""
    ...
    async def _comprehensive_cleanup(self, target_path: str, context: Dict[str, Any]) -> Dict[str, Any]:
