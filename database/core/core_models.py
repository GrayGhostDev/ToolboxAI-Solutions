...
class User(Base):
    ...
    courses_enrolled = relationship(
        "Course", secondary="enrollments", viewonly=True, overlaps="enrollments"
    )
    courses_teaching = relationship(
        "Course", secondary="enrollments", viewonly=True, overlaps="enrollments,courses_enrolled"
    )
...
class Course(Base):
    ...
    enrolled_students = relationship(
        "User", secondary="enrollments", viewonly=True, overlaps="enrollments"
    )
