...
def upgrade():
    ...
    op.create_table(
        ...
        # File properties
        sa.Column('status', postgresql.ENUM('pending', 'processing', 'available', 'quarantined', 'deleted', 'archived', 'error', name='file_status'), nullable=False),
        sa.Column('category', postgresql.ENUM('educational_content', 'student_submission', 'assessment', 'administrative', 'media_resource', 'temporary', 'avatar', 'report', name='file_category'), nullable=False),
    ...
    op.create_table(
        ...
        # Share configuration
        sa.Column('share_type', postgresql.ENUM('public_link', 'organization', 'specific_users', 'class', 'temporary', name='share_type'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('total_quota', sa.BigInteger(), nullable=False, default=1073741824),  # 1GB default
