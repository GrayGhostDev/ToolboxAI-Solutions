...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_agent_instances_organization",
        "agent_instances",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "idx_agent_org_type_status", "agent_instances", ["organization_id", "agent_type", "status"]
    )
    ...
    op.create_foreign_key(
        "fk_agent_executions_organization",
        "agent_executions",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "idx_execution_org_status_created",
        "agent_executions",
    ...
    op.add_column(
        "agent_metrics", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_agent_metrics_organization",
        "agent_metrics",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "idx_metrics_org_period", "agent_metrics", ["organization_id", "period_start", "period_end"]
    )
    ...
    op.create_foreign_key(
        "fk_agent_task_queue_organization",
        "agent_task_queue",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "idx_queue_org_priority_created",
        "agent_task_queue",
    ...
    op.create_foreign_key(
        "fk_agent_configurations_organization",
        "agent_configurations",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_agent_configurations_organization_id", "agent_configurations", ["organization_id"]
    )
    op.create_index(
        "idx_config_org_active",
        "agent_configurations",
        ["organization_id", "is_active", "agent_type"],
    )
    ...
    op.create_foreign_key(
        "fk_roblox_environments_organization",
        "roblox_environments",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_roblox_environments_organization_id", "roblox_environments", ["organization_id"]
    )
    op.create_index(
        "idx_roblox_env_org_user_status",
        "roblox_environments",
    ...
    op.create_foreign_key(
        "fk_roblox_sessions_organization",
        "roblox_sessions",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_environment_shares_organization",
        "environment_shares",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_environment_shares_organization_id", "environment_shares", ["organization_id"]
    )
    op.create_index(
        "idx_env_share_org_user", "environment_shares", ["organization_id", "shared_with_user_id"]
    )
    ...
    op.create_foreign_key(
        "fk_environment_templates_organization",
        "environment_templates",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_environment_templates_organization_id", "environment_templates", ["organization_id"]
    )
    op.create_index(
        "idx_template_org_category", "environment_templates", ["organization_id", "category"]
    )
    ...
    op.add_column(
        "customers", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
    ...
    op.add_column(
        "subscriptions", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        "fk_subscription_items_organization",
        "subscription_items",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_subscription_items_organization_id", "subscription_items", ["organization_id"]
    )
    ...
    op.create_foreign_key(
        "fk_payment_methods_organization",
        "payment_methods",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "idx_payment_method_org_customer", "payment_methods", ["organization_id", "customer_id"]
    )

    # Payment - Add organization_id
    op.add_column(
        "payments", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_payments_organization",
        "payments",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.add_column(
        "invoices", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
    ...
    op.add_column(
        "invoice_items", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_invoice_items_organization",
        "invoice_items",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.add_column(
        "refunds", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_refunds_organization",
        "refunds",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.add_column(
        "usage_records", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "fk_usage_records_organization",
        "usage_records",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.add_column(
        "coupons", sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=True)
    )  # NULL = platform-wide
    op.create_foreign_key(
        "fk_coupons_organization",
        "coupons",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_enhanced_content_generations_organization",
        "enhanced_content_generations",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_enhanced_content_generations_organization_id",
        "enhanced_content_generations",
        ["organization_id"],
    )
    op.create_index(
        "idx_ecg_org_user_status",
        "enhanced_content_generations",
        ["organization_id", "user_id", "status"],
    )
    ...
    op.create_foreign_key(
        "fk_content_quality_metrics_organization",
        "content_quality_metrics",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_content_quality_metrics_organization_id", "content_quality_metrics", ["organization_id"]
    )
    ...
    op.create_foreign_key(
        "fk_learning_profiles_organization",
        "learning_profiles",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_learning_profiles_organization_id", "learning_profiles", ["organization_id"]
    )
    ...
    op.create_foreign_key(
        "fk_content_personalization_log_organization",
        "content_personalization_log",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_content_personalization_log_organization_id",
        "content_personalization_log",
        ["organization_id"],
    )
    ...
    op.create_foreign_key(
        "fk_content_feedback_organization",
        "content_feedback",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_content_generation_batches_organization",
        "content_generation_batches",
        "organizations",
        ["organization_id"],
        ["id"],
    ...
    op.create_index(
        "ix_content_generation_batches_organization_id",
        "content_generation_batches",
        ["organization_id"],
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_content_generation_batches_organization_id", table_name="content_generation_batches"
    )
    op.drop_constraint(
        "fk_content_generation_batches_organization",
        "content_generation_batches",
    ...
    op.drop_index(
        "ix_content_personalization_log_organization_id", table_name="content_personalization_log"
    )
    op.drop_constraint(
        "fk_content_personalization_log_organization",
        "content_personalization_log",
    ...
    op.drop_index(
        "ix_content_quality_metrics_organization_id", table_name="content_quality_metrics"
    )
    op.drop_constraint(
        "fk_content_quality_metrics_organization", "content_quality_metrics", type_="foreignkey"
    )
    ...
    op.drop_index(
        "ix_enhanced_content_generations_organization_id", table_name="enhanced_content_generations"
    )
    op.drop_constraint(
        "fk_enhanced_content_generations_organization",
        "enhanced_content_generations",
    ...
    op.drop_constraint(
        "fk_subscription_items_organization", "subscription_items", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_environment_templates_organization", "environment_templates", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_environment_shares_organization", "environment_shares", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_roblox_environments_organization", "roblox_environments", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_agent_configurations_organization", "agent_configurations", type_="foreignkey"
    )
