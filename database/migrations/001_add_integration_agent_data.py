...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "last_check_at", sa.DateTime(timezone=True), server_default=sa.text("CURRENT_TIMESTAMP")
        ),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.text("CURRENT_TIMESTAMP")
        ),
    ...
    try:
        ...
        op.create_foreign_key(
            "fk_student_progress_student", "student_progress", "users", ["student_id"], ["id"]
        )

        op.create_foreign_key(
            "fk_student_progress_lesson", "student_progress", "lessons", ["lesson_id"], ["id"]
        )
