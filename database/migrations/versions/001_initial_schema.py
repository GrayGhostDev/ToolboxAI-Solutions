...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('notification_settings', postgresql.JSONB(), server_default='{"email": true, "in_app": true}'),
    ...
    op.create_table('quiz_questions',
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.CheckConstraint("question_type IN ('multiple_choice', 'true_false', 'short_answer', 'essay', 'matching', 'ordering')"),
        schema='toolboxai'
    )
    ...
    op.create_table('user_achievements',
        ...
        sa.ForeignKeyConstraint(['user_id'], ['toolboxai.users.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['achievement_id'], ['toolboxai.achievements.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('content_generation_history',
        sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    tables_with_updated_at = [
        'users', 'courses', 'lessons', 'quizzes', 'quiz_questions',
        'student_progress'
    ]
