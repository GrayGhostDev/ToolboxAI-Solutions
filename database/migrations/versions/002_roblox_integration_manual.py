...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('template_type', postgresql.ENUM('SCRIPT', 'MODEL', 'TERRAIN', 'GUI', 'ANIMATION', 'SOUND', 'TEXTURE', 'MESH', name='robloxcontenttype', create_type=False), nullable=False),
        ...
        sa.Column('learning_objectives_template', postgresql.JSONB(), default=sa.text("'[]'::jsonb")),
    ...
    op.create_index('idx_roblox_template_grade', 'roblox_templates', ['grade_level_min', 'grade_level_max'])
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('ACTIVE', 'PAUSED', 'COMPLETED', 'DISCONNECTED', 'ERROR', name='robloxsessionstatus', create_type=False), default='ACTIVE'),
        ...
        sa.Column('parental_consent_ids', postgresql.ARRAY(sa.String()), default=sa.text("'{}'::text[]")),
    ...
    op.create_table(
        ...
        sa.Column('content_type', postgresql.ENUM('SCRIPT', 'MODEL', 'TERRAIN', 'GUI', 'ANIMATION', 'SOUND', 'TEXTURE', 'MESH', name='robloxcontenttype', create_type=False), nullable=False),
        sa.Column('version', sa.String(20), default='1.0.0'),
    ...
    op.create_table(
        ...
        sa.Column('difficulty_level', postgresql.ENUM('BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'EXPERT', name='difficultylevel', create_type=False), default='INTERMEDIATE'),
    ...
    op.create_table(
        ...
        sa.Column('achievement_type', postgresql.ENUM('MILESTONE', 'STREAK', 'COMPLETION', 'MASTERY', 'SPECIAL', name='achievementtype', create_type=False), nullable=False),
        sa.Column('description', sa.Text()),
