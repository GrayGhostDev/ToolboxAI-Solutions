...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "NORMAL", "HIGH", "URGENT", "CRITICAL", name="taskpriority"),
            nullable=True,
        ),
    ...
    op.create_index(
        ...
        "agent_executions",
        ["execution_time_seconds", "quality_score"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_executions_agent_instance_id"),
        "agent_executions",
        ["agent_instance_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "success_rate >= 0 AND success_rate <= 100", name="check_success_rate_range"
        ),
    ...
    op.create_index(
        op.f("ix_agent_metrics_agent_instance_id"),
        "agent_metrics",
        ["agent_instance_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "system_success_rate >= 0 AND system_success_rate <= 100",
    ...
    op.create_index(
        "idx_health_score",
        "system_health",
        ["overall_health_score", "availability_percentage"],
        unique=False,
    )
    op.create_index(
        op.f("ix_system_health_timestamp"), "system_health", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_agent_configurations_created_by"),
        "agent_configurations",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_configurations_environment"),
        "agent_configurations",
        ["environment"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_configurations_is_active"),
        "agent_configurations",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_configurations_is_default"),
        "agent_configurations",
        ["is_default"],
        unique=False,
    )
