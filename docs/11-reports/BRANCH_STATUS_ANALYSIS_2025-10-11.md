...
?? docs/05-implementation/testing/reports/TESTING_KNOWN_ISSUES.md       (Known issues)
?? docs/05-implementation/development-setup/TSCONFIG_FIXES_2025.md        (TypeScript fixes)
```
