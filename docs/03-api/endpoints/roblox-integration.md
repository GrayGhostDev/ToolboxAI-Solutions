...
```json
{
  ...
  "websocket_endpoint": "ws://127.0.0.1:8008/ws/plugin/reg_xyz789",
...
Real-time Roblox environment synchronization.
...
#### ws://127.0.0.1:8008/ws/plugin/{plugin_id}
Direct plugin communication channel.
