...
*For high-level overview, see [System Architecture Overview](../01-overview/system-architecture.md). For implementation details, see [Implementation Documentation](../04-implementation/).*