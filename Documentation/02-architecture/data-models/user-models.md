...
*For related models, see [Progress Models](progress-models.md) for user activity tracking. For authentication implementation, see [API Documentation](../../03-api/authentication.md).*