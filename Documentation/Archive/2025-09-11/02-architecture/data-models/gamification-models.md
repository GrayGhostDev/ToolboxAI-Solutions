...
*For user profiles, see [User Models](user-models.md). For learning progress, see [Progress Models](progress-models.md). For analytics on gamification, see [Analytics Models](analytics-models.md).*