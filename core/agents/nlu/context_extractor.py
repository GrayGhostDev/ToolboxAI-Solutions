...
class ContextExtractor:
    ...
    def _init_extraction_patterns(self) -> dict[str, list[tuple[str, Any]]]:
        ...
        return {
            "learning_objectives": [
                (
                    r"students? (?:will|should) (?:be able to )?(\w+)",
                    lambda m: m.group(1),
                ),
    ...
    def _infer_bloom_levels(self, context: EducationalContext):
        ...
        bloom_keywords = {
            LearningObjectiveLevel.REMEMBER: [
                "recall",
                "identify",
                "recognize",
                "name",
            ...
            LearningObjectiveLevel.UNDERSTAND: [
                "explain",
                "describe",
                "summarize",
                "interpret",
            ],
            LearningObjectiveLevel.APPLY: [
                "apply",
                "use",
                "implement",
                "solve",
            ...
            LearningObjectiveLevel.ANALYZE: [
                "analyze",
                "compare",
                "contrast",
                "examine",
            ...
            LearningObjectiveLevel.EVALUATE: [
                "evaluate",
                "judge",
                "assess",
                "critique",
    ...
    def merge_contexts(
        self, context1: EducationalContext, context2: EducationalContext
    ) -> EducationalContext:
        ...
        merged.curriculum_standards = list(
            set(context1.curriculum_standards + context2.curriculum_standards)
        )
        merged.engagement_strategies = list(
            set(context1.engagement_strategies + context2.engagement_strategies)
        )
