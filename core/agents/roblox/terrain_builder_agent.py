...
"""
    ...
    async def _add_educational_landmarks(
        self, terrain_data: dict[str, Any], educational_elements: list[str]
    ) -> list[dict[str, Any]]:
    ...
    def _generate_terrain_script(
        self, terrain_data: dict[str, Any], landmarks: list[dict[str, Any]]
    ) -> str:
