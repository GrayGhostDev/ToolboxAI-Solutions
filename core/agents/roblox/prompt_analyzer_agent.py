...
class RobloxPromptAnalyzerAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[AgentConfig] = None):
        ...
        self.subject_keywords = {
            ...
            SubjectArea.PHYSICAL_EDUCATION: [
                "physical",
                "sports",
                "exercise",
                "fitness",
...
"""
    ...
    async def _process_task(self, state: AgentState) -> Any:
        ...
        if not prompt:
            return {"error": "No prompt provided for analysis", "requirements": {}}
    ...
    async def _extract_learning_objectives(
        self, prompt: str, subjects: list[str]
    ) -> list[dict[str, Any]]:
        ...
        try:
            ...
            for line in lines:
                ...
                if line.startswith("- Objective"):
                    ...
                    current_objective["assessment"] = line.replace(
                        "- Assessment Method:", ""
                    ).strip()
            ...
            return (
                objectives
                if objectives
                else [{"description": "General learning", "skill_level": "beginner"}]
            )
    ...
    async def _suggest_game_mechanics(
        self, prompt: str, subjects: list[str], grade_level: int
    ) -> list[str]:
        ...
        if grade_level <= 2:  # K-2
            ...
            mechanics.extend(
                ["simulation", "programming", "advanced_strategy", "creative_building"]
            )
