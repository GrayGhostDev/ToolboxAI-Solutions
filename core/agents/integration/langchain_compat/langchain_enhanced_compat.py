...
try:
    ...
    # Schema definitions
    from langchain_core.schema import BaseOutputParser, BaseRetriever
    ...
    try:
        ...
        if provider == "openai":
            return ChatOpenAI(
                ...
                max_tokens=max_tokens,
                streaming=streaming,
                http_client=None,  # Fix for OpenAI 1.109.1 httpx client incompatibility
...
def create_agent_workflow(
    agent_function: Callable, tools: list[Any] = None, memory: Optional[Any] = None
) -> Any:
    """
