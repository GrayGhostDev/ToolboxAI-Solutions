...
class CodeQualityChecker:
    ...
    def _calculate_complexity_score(self, lua_code: str) -> float:
        ...
        decision_keywords = [
            ...
            r'\brepeat\b', r'\band\b', r'\bor\b', r'\bfunction\b'
        ]
    ...
    def _generate_recommendations(self, issues: List[QualityIssue], metrics: QualityMetrics,
                                best_practices: List[str]) -> List[str]:
