...
class TestDatabasePool2025:
    ...
    def test_database_initialization(self):
        ...
        assert "education" in db_manager.engines
        assert "education" in db_manager.async_engines
        
        # Verify pool monitors are created
        assert "education" in db_manager.pool_monitors
    ...
    def test_connection_pool_monitoring(self):
        ...
        if monitor:
            ...
            assert final_checkouts > initial_checkouts, "Checkout count should increase"
