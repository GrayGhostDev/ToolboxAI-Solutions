...
from apps.backend.core.security.session_manager import (
    SessionManager, SessionInfo, SessionEvent, get_session_manager,
...
class TestSessionManager:
    ...
    def test_validate_session_fingerprint_with_redis(self):
        ...
        assert self.session_manager.validate_session_fingerprint(session_id, ip, user_agent) is False
...
class TestSessionManagerIntegration:
    ...
    def test_session_security_features(self):
        ...
        assert manager.validate_session_fingerprint(
            session.session_id,
            "192.168.1.1",
