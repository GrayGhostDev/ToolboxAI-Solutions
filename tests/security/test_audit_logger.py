...
class TestSecurityAuditLogger:
    ...
    async def test_no_redis_graceful_handling(self):
        ...
        logger = SecurityAuditLogger(
            service_name="test_service", redis_client=None, async_mode=False
        )
    ...
    def test_no_database_graceful_handling(self):
        ...
        logger = SecurityAuditLogger(
            service_name="test_service", db_session=None, enable_db_logging=False, async_mode=False
        )
...
class TestErrorHandling:
    ...
    def test_file_permission_errors(self):
        ...
        logger = SecurityAuditLogger(
            service_name="test", log_file_path=invalid_path, async_mode=False
        )
    ...
    def test_integrity_hash_with_different_keys(self):
        ...
        logger1 = SecurityAuditLogger(service_name="test", integrity_key="key1", async_mode=False)

        logger2 = SecurityAuditLogger(service_name="test", integrity_key="key2", async_mode=False)
    ...
    async def test_alert_callback_errors(self):
        ...
        logger = SecurityAuditLogger(service_name="test", async_mode=False)
