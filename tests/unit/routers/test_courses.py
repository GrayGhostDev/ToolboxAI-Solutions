...
class TestCoursesRouter:
    ...
    def test_create_course_success(self, test_client, mock_db_session, sample_course_data):
        ...
        instructor_query.filter.return_value.first.return_value = Mock(id=sample_course_data['instructor_id'])
    ...
    def test_create_course_instructor_not_found(self, test_client, mock_db_session, sample_course_data):
