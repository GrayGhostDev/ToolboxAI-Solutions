...
class TestTenantProvisioning:
    ...
    async def test_provision_tenant_success(self, mock_provisioner_class, mock_session, sample_organization):
        ...
        mock_provisioner.provision_tenant = AsyncMock(return_value={
            "status": "success",
