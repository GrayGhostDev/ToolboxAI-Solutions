...
def mock_stripe_service():
    ...
    with patch('apps.backend.api.v1.endpoints.stripe_webhooks.StripeService') as mock:
        ...
        service_instance._handle_checkout_completed = AsyncMock(return_value={"status": "processed"})
        service_instance._handle_subscription_created = AsyncMock(return_value={"status": "processed"})
        service_instance._handle_subscription_updated = AsyncMock(return_value={"status": "processed"})
        service_instance._handle_subscription_deleted = AsyncMock(return_value={"status": "processed"})
...
class TestWebhookMainHandler:
    ...
    async def test_webhook_handler_success_no_signature(self, mock_request, sample_webhook_event, mock_stripe_service):
    ...
    @patch('apps.backend.api.v1.endpoints.stripe_webhooks.ENABLE_STRIPE_WEBHOOKS', True)
    @patch('apps.backend.api.v1.endpoints.stripe_webhooks.STRIPE_WEBHOOK_SECRET', 'whsec_test')
    @patch('apps.backend.api.v1.endpoints.stripe_webhooks.verify_stripe_signature', return_value=False)
    async def test_webhook_handler_invalid_signature(self, mock_verify, mock_request, sample_webhook_event):
...
class TestEventHandlers:
    ...
    @pytest.mark.asyncio
    async def test_handle_checkout_completed(self, sample_webhook_event, sample_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_handle_subscription_created(self, sample_webhook_event, sample_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_handle_subscription_updated(self, sample_webhook_event, sample_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_handle_subscription_deleted(self, sample_webhook_event, sample_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_handle_payment_succeeded(self, sample_webhook_event, sample_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_handle_payment_failed(self, sample_webhook_event, sample_org_id, mock_stripe_service):
...
class TestMultiTenantSecurity:
    ...
    @pytest.mark.asyncio
    async def test_organization_id_passed_to_service(self, sample_webhook_event, sample_org_id, mock_stripe_service):
