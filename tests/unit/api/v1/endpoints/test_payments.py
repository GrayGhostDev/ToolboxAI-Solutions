...
class TestCustomerEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_create_customer_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.create_customer = AsyncMock(return_value={
            "id": "cus_123",
            "email": "test@example.com"
        })
    ...
    @pytest.mark.asyncio
    async def test_create_customer_already_exists(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_get_my_customer_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
...
class TestSubscriptionEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_create_subscription_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.create_subscription = AsyncMock(return_value={
    ...
    @pytest.mark.asyncio
    async def test_update_subscription_cancel(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_cancel_subscription_immediately(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
...
class TestPaymentMethodEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_attach_payment_method_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_get_payment_methods(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.list_payment_methods = AsyncMock(return_value=[
            {"id": "pm_1", "type": "card"},
            {"id": "pm_2", "type": "card"}
        ])
...
class TestPaymentIntentEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_create_payment_intent_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.create_payment_intent = AsyncMock(return_value={
            "id": "pi_123",
    ...
    @pytest.mark.asyncio
    async def test_create_checkout_session(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
...
class TestWebhookEndpoints:
    ...
    async def test_stripe_webhook_success(self, mock_db_session, mock_stripe_service):
        ...
        mock_stripe_service.handle_webhook = AsyncMock(return_value=(
            True,
...
class TestInvoiceEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_invoices_success(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.get_invoices = AsyncMock(return_value=[
...
class TestRefundEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_create_refund_admin_success(self, mock_db_session, mock_admin_user, mock_org_id, mock_stripe_service):
        ...
        mock_stripe_service.create_refund = AsyncMock(return_value={
            "id": "re_123",
            "amount": 1000,
            "status": "succeeded"
        })
...
class TestRevenueAnalytics:
    ...
    @pytest.mark.asyncio
    async def test_get_revenue_analytics_admin(self, mock_admin_user, mock_org_id, mock_stripe_service):
        """Test revenue analytics retrieval by admin."""
        # Arrange
        start_date = datetime(2025, 10, 1)
        end_date = datetime(2025, 10, 31)
        
        mock_stripe_service.get_revenue_metrics = AsyncMock(return_value={
            "total_revenue": 50000,
...
class TestMultiTenantIsolation:
    ...
    @pytest.mark.asyncio
    async def test_customer_scoped_to_organization(self, mock_db_session, mock_user, mock_org_id, mock_stripe_service):
    ...
    @pytest.mark.asyncio
    async def test_subscription_cross_org_access_denied(self, mock_db_session, mock_user, mock_org_id):
