...
class TestSecureCORSConfig:
    ...
    def test_production_configuration(self):
        ...
        config = SecureCORSConfig(environment="production", allowed_origins=allowed_origins)
    ...
    def test_preflight_headers(self):
        ...
        headers = config.get_preflight_headers(
            "https://app.example.com", "POST", "Content-Type, Authorization"
        )
        ...
        # Disallowed origin should get empty headers
        headers = config.get_preflight_headers("https://evil.com", "POST", "Content-Type")
        assert headers == {}
...
class TestCORSMiddlewareWithLogging:
    ...
    async def test_cors_violation_logging(self):
        ...
        _scope = {  # noqa: F841 - Reserved for future full async test implementation
            "type": "http",
            "method": "GET",
            "path": "/api/test",
            "headers": [
        ...
        _receive = Mock()  # noqa: F841 - Reserved for future full async test
        _send = Mock()  # noqa: F841 - Reserved for future full async test
...
class TestCORSWithFastAPI:
    ...
    def test_client(self):
        ...
        app.add_middleware(CORSMiddlewareWithLogging, cors_config=config)
    ...
    def test_allowed_origin_request(self, test_client):
        ...
        response = test_client.get("/test", headers={"Origin": "https://app.example.com"})
    ...
    def test_disallowed_origin_request(self, test_client):
        ...
        response = test_client.get("/test", headers={"Origin": "https://evil.com"})
