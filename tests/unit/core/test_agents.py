...
from core.agents.orchestrator import OrchestrationResult, Orchestrator
...
from core.agents.testing_agent import TestingAgent, TestSuiteResult, TestType
...
class TestContentAgent:
    ...
    async def test_generate_educational_content(self, content_agent):
        ...
        content_agent.llm.ainvoke = AsyncMock(
            return_value=AIMessage(content="Test educational content")
        )
    ...
    async def test_content_with_interactive_elements(self, content_agent):
        ...
        context = {"subject": "Science", "grade_level": "7", "topic": "Solar System"}
...
class TestQuizAgent:
    ...
    async def test_generate_quiz(self, quiz_agent):
        ...
        context = {"subject": "Mathematics", "difficulty": "medium", "num_questions": 5}
    ...
    async def test_generate_adaptive_quiz(self, quiz_agent):
        ...
        context = {"student_performance": {"average_score": 75, "weak_topics": ["Fractions"]}}
...
class TestSupervisorAgent:
    ...
    def test_validate_response(self, supervisor_agent):
        ...
        invalid_response = {"error": "Agent failed", "status": "error"}
...
class TestOrchestrator:
                    ...
                    with patch("core.agents.orchestrator.TerrainAgent"):
                        with patch("core.agents.orchestrator.ScriptAgent"):
                            with patch("core.agents.orchestrator.ReviewAgent"):
                                with patch(
                                    "core.agents.base_agent.from langchain_openai import ChatOpenAI"
                                ):
                                    orch = Orchestrator()
    ...
    async def test_review_code(self, orchestrator):
        ...
        code_files = {"main.lua": "print('Hello')", "quiz.lua": "-- Quiz script"}
...
class TestAgentIntegration:
    ...
    async def test_full_content_generation_pipeline(self):
        ...
        with patch("core.agents.orchestrator.Orchestrator") as MockOrchestrator:
            ...
            orchestrator.generate_experience = AsyncMock(
                return_value={
...
class TestTestingAgent:
    ...
    def test_parse_pytest_output(self, testing_agent):
        ...
        result = testing_agent._parse_pytest_output(stdout, stderr, 0, TestType.UNIT, command, 2.5)
    ...
    def test_determine_test_type_for_agent(self, testing_agent):
        ...
        assert (
            testing_agent._determine_test_type_for_agent("ContentAgent", {}) == TestType.INTEGRATION
        )
