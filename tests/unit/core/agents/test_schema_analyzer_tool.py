    ...
    async def test_analyze_success(self, mock_engine, mock_inspector, mock_connection):
        ...
        with (
            ...
            with (
                ...
                mock_enums.return_value = [
                    {"name": "user_status", "values": ["active", "inactive"]}
                ]
                ...
                result = await tool.analyze("postgresql://user:pass@localhost/test_db", "test_db")
    ...
    async def test_analyze_failure(self, mock_engine):
        ...
        with (
            ...
            with pytest.raises(Exception, match="Connection failed"):
                await tool.analyze("postgresql://invalid:conn@localhost/test_db", "test_db")
...
class TestTableInfo:
    ...
    def test_table_info_with_all_fields(self):
        ...
        table_info = TableInfo(
            ...
            constraints=[{"name": "ck_data_format", "type": "CHECK"}],
            indexes=[{"name": "idx_data_gin", "type": "GIN", "columns": ["data"]}],
            row_count=50000,
            size_bytes=10485760,
        )
