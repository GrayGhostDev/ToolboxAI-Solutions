...
def sample_access_patterns():
    ...
    return {
        ...
        "posts": {"multi_tenant": False, "hierarchical": True, "time_based": False},
        "admin_settings": {"multi_tenant": False, "hierarchical": False, "time_based": False},
    }
...
class TestRLSPolicyGeneratorTool:
    ...
    async def test_generate_policies_with_access_patterns(
        self, sample_schema, sample_access_patterns
    ):
    ...
    def test_generate_content_policies(self):
        ...
        assert (
            "published" in public_policy["using_clause"]
            or "approved" in public_policy["using_clause"]
        )
    ...
    async def test_generate_table_policies_with_access_patterns(self, sample_access_patterns):
        ...
        policies = await tool._generate_table_policies(
            "lessons", table_info, sample_access_patterns
        )
