...
def mock_external_services():
    ...
    with patch("openai.AsyncOpenAI") as mock_openai, patch("asyncpg.connect") as mock_asyncpg:
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "supabase: mark test as a Supabase migration test")
    config.addinivalue_line("markers", "schema_analysis: mark test as schema analysis test")
    config.addinivalue_line("markers", "rls_policy: mark test as RLS policy test")
    config.addinivalue_line("markers", "data_migration: mark test as data migration test")
    config.addinivalue_line("markers", "migration_agent: mark test as migration agent test")
