...
if str(project_root) not in sys.path:
    ...
    def test_register_plugin(self):
        ...
        plugin_data = {"studio_id": "test-studio", "port": 64989, "version": "1.0.0"}
...
class TestPluginSecurity:
    ...
    def test_plugin_validation(self):
        ...
        # Valid request
        valid_request = {"type": "content", "payload": {"data": "test"}, "plugin_id": "test-plugin"}
...
class TestFlaskEndpoints:
    ...
    def test_register_plugin_endpoint(self, client):
        ...
        response = client.post(
            "/register_plugin", json=plugin_data, content_type="application/json"
        )
    ...
    def test_register_plugin_invalid_data(self, client):
        ...
        response = client.post("/register_plugin", json=None, content_type="application/json")
