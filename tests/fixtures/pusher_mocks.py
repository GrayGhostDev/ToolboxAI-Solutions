...
class MockPusherClient:
    ...
    def authenticate(self, channel: str, socket_id: str, custom_data: Optional[Dict] = None) -> Dict:
...
class MockPusherService:
    ...
    def authenticate(self, channel: str, socket_id: str, user_data: Optional[Dict] = None) -> Dict:
...
class MockPusherConnection:
    ...
    def disconnect(self):
        ...
        self._trigger_callbacks('state_change', {'current': 'disconnected', 'previous': 'connected'})
    ...
    def connect(self):
        ...
        self._trigger_callbacks('state_change', {'current': 'connected', 'previous': 'disconnected'})
    ...
    def channel(self, channel_name: str) -> Optional[MockPusherChannelSubscription]:
...
def mock_pusher_with_channels():
    ...
    service.client.add_channel('presence-room-456', [
