...
def sample_yaml_data():
    ...
    return {
        "application": {"name": "ToolboxAI", "version": "2.0.0", "environment": "test"},
        "database": {"host": "localhost", "port": 5432, "name": "test_db", "pool_size": 10},
        "cache": {"type": "redis", "ttl": 3600, "max_entries": 1000},
        "features": ["authentication", "content_generation", "analytics", "reporting"],
    }
...
def mock_metrics():
    ...
    metrics_data = {"counters": {}, "gauges": {}, "histograms": {}, "timers": {}}
