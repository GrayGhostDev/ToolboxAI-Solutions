...
class TestUserEndpoints:
    ...
    async def test_get_user_profile(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.get("/api/v1/users/me/profile", headers=auth_headers)
    ...
    async def test_update_profile_invalid_email(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.patch(
            "/api/v1/users/me/profile", json={"email": "invalid-email"}, headers=auth_headers
        )
    ...
    async def test_delete_avatar(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.delete("/api/v1/users/me/avatar", headers=auth_headers)
    ...
    async def test_get_user_by_id(
        ...
        response = await test_client.get(f"/api/v1/users/{test_user.id}", headers=admin_headers)
    ...
    async def test_get_user_by_id_forbidden(
        ...
        response = await test_client.get(f"/api/v1/users/{admin_user.id}", headers=auth_headers)
    ...
    async def test_list_users(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.get("/api/v1/users", headers=admin_headers)
    ...
    async def test_list_users_pagination(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.get("/api/v1/users?page=1&limit=10", headers=admin_headers)
    ...
    async def test_list_users_filter_by_role(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.get("/api/v1/users?role=teacher", headers=admin_headers)
    ...
    async def test_search_users(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.get("/api/v1/users/search?q=test", headers=admin_headers)
    ...
    async def test_update_user_role(
        ...
        response = await test_client.patch(
            f"/api/v1/users/{test_user.id}/role", json={"role": "teacher"}, headers=admin_headers
        )
    ...
    async def test_update_user_role_forbidden(
        ...
        response = await test_client.patch(
            f"/api/v1/users/{test_user.id}/role", json={"role": "admin"}, headers=teacher_headers
        )
    ...
    async def test_activate_deactivate_user(
        ...
        # Deactivate user
        response = await test_client.patch(
            f"/api/v1/users/{test_user.id}/status", json={"is_active": False}, headers=admin_headers
        )
        ...
        # Reactivate user
        response = await test_client.patch(
            f"/api/v1/users/{test_user.id}/status", json={"is_active": True}, headers=admin_headers
        )
    ...
    async def test_delete_user(
        ...
        response = await test_client.delete(
            f"/api/v1/users/{user_to_delete.id}", headers=admin_headers
        )
    ...
    async def test_delete_user_forbidden(
        ...
        response = await test_client.delete(f"/api/v1/users/{admin_user.id}", headers=auth_headers)
    ...
    async def test_get_user_statistics(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.get("/api/v1/users/me/statistics", headers=auth_headers)
    ...
    async def test_get_user_activity(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.get("/api/v1/users/me/activity", headers=auth_headers)
    ...
    async def test_get_user_preferences(self, test_client: AsyncClient, auth_headers: dict):
        ...
        response = await test_client.get("/api/v1/users/me/preferences", headers=auth_headers)
...
class TestUserBulkOperations:
    ...
    @pytest.mark.asyncio
    async def test_bulk_create_users(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.post(
            "/api/v1/users/bulk", json=users_data, headers=admin_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_users(self, test_client: AsyncClient, admin_headers: dict):
        """Test bulk user updates (admin only)."""
        updates = {"user_ids": [1, 2, 3], "updates": {"is_active": False, "role": "student"}}

        response = await test_client.patch(
            "/api/v1/users/bulk", json=updates, headers=admin_headers
        )

        assert response.status_code in [200, 404, 501]

    @pytest.mark.asyncio
    async def test_bulk_delete_users(self, test_client: AsyncClient, admin_headers: dict):
    ...
    @pytest.mark.asyncio
    async def test_export_users(self, test_client: AsyncClient, admin_headers: dict):
        """Test exporting users to CSV/Excel (admin only)."""
        response = await test_client.get("/api/v1/users/export?format=csv", headers=admin_headers)
    ...
    @pytest.mark.asyncio
    async def test_import_users(self, test_client: AsyncClient, admin_headers: dict):
        ...
        response = await test_client.post(
            "/api/v1/users/import", files=files, headers=admin_headers
        )
