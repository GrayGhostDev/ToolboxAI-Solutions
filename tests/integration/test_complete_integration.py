...
# Test credentials
TEST_USER = {"username": "john_teacher", "password": "Teacher123!"}
...
class IntegrationTester:
    ...
    def test_api_endpoints(self) -> bool:
        ...
        for endpoint, name in endpoints:
            try:
                response = requests.get(f"{FASTAPI_URL}{endpoint}", headers=headers, timeout=5)
    ...
    def test_websocket_connection(self) -> bool:
        ...
        try:
            ...
            test_message = json.dumps(
                {"type": "ping", "data": "test"}, default=make_json_serializable
            )
    ...
    def test_roblox_integration(self) -> bool:
        ...
        try:
            ...
            response = requests.post(f"{FLASK_URL}/plugin/register", json=plugin_data, timeout=5)
    ...
    def test_data_persistence(self) -> bool:
        ...
        try:
            ...
            # Store via API
            response = requests.post(
                f"{FASTAPI_URL}/lessons/", json=test_data, headers=headers, timeout=5
            )
            ...
            if response.status_code in [200, 201]:
                ...
                if lesson_id:
                    response = requests.get(
                        f"{FASTAPI_URL}/lessons/{lesson_id}", headers=headers, timeout=5
                    )
    ...
    def test_error_handling(self) -> bool:
        ...
        try:
            ...
            # Test invalid data
            response = requests.post(
                f"{FASTAPI_URL}/generate_content", json={"invalid": "data"}, timeout=5
            )
