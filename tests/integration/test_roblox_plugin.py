...
class RobloxPluginTester:
    ...
    def check_services(self):
        ...
        self.test_results.append({"test": "Service Health Check", "passed": all_healthy})
    ...
    def test_plugin_registration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                validate_response = requests.get(f"{self.flask_url}/plugin/{plugin_id}")

                if validate_response.status_code == 200:
                    print(f"   ✅ Session validated successfully")
                    self.test_results.append({"test": "Plugin Registration", "passed": True})
                    return True
                else:
        ...
        self.test_results.append({"test": "Plugin Registration", "passed": False})
        return False
    ...
    def test_content_generation(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.validate_content_structure(data):
                    ...
                    self.test_results.append({"test": "Content Generation", "passed": True})
                    return True
                else:
        ...
        self.test_results.append({"test": "Content Generation", "passed": False})
        return False
    ...
    def test_terrain_generation(self):
            ...
            if response.status_code == 200:
                ...
                if data.get("script"):
                    ...
                    if "TerrainGenerator" in script or "generateTerrain" in script:
                        ...
                        self.test_results.append({"test": "Terrain Generation", "passed": True})
                        return True
                    else:
        ...
        self.test_results.append({"test": "Terrain Generation", "passed": False})
        return False
    ...
    def test_quiz_creation(self):
            ...
            if response.status_code == 200:
                ...
                if data.get("script"):
                    ...
                    if "QuizUI" in script or "createQuiz" in script:
                        ...
                        self.test_results.append({"test": "Quiz Creation", "passed": True})
                        return True
            else:
        ...
        self.test_results.append({"test": "Quiz Creation", "passed": False})
        return False
    ...
    def test_object_placement(self):
                ...
                json={
                    ...
                    "config": {
                        "objects": [
                            ...
                            {
                                "type": "periodic_table",
                                "name": "Elements Display",
                                "position": {"x": -10, "y": 10, "z": 0},
                            },
                            {
                                "type": "book",
                                "name": "Astronomy Guide",
                                "title": "Guide to the Stars",
            ...
            if response.status_code == 200:
                ...
                if data.get("script"):
                    ...
                    if "ObjectPlacer" in script or "placeObjects" in script:
                        ...
                        self.test_results.append({"test": "Object Placement", "passed": True})
                        return True
            else:
        ...
        self.test_results.append({"test": "Object Placement", "passed": False})
        return False
    ...
    def test_websocket_fallback(self):
        ...
        try:
            ...
            response = requests.post(
                ...
                json={"sessionId": self.session_id, "type": "roblox_studio", "version": "Studio"},
            )
            ...
            if response.status_code == 200:
                ...
                poll_response = requests.get(
                    f"{self.flask_url}/fallback/poll", headers={"X-Session-Id": self.session_id}
                )
                ...
                if poll_response.status_code == 200:
                    ...
                    if send_response.status_code == 200:
                        ...
                        self.test_results.append({"test": "WebSocket Fallback", "passed": True})
                        return True
                else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("lesson_plan"):
                    print(
                        f"      - Lesson objectives: {len(data['lesson_plan'].get('objectives', []))}"
                    )
                    print(f"      - Activities: {len(data['lesson_plan'].get('activities', []))}")
                    print(f"      - Resources: {len(data['lesson_plan'].get('resources', []))}")

                    self.test_results.append({"test": "Real Data Integration", "passed": True})
                    return True
            else:
                ...
                db_response = requests.get(
                    f"{self.fastapi_url}/api/lessons", params={"subject": "Mathematics", "grade": 8}
                )
