  ...
  return (
    ...
    >
      <ScrollArea h="100vh">
        ...
        {/* Navigation Menu */}
        <Stack spacing={4} p="xs" mt="sm" data-theme="dark" className={styles.navLinkWrapper}>
          {menuItems.map((item) => {
            const isActive = location.pathname === item.path;
            // Create test ID from label (e.g., "Roblox Studio" -> "nav-roblox-studio")
                ...
                styles={(theme) => ({
                  root: {
                    ...
                    '&:hover': {
                      ...
                      backgroundImage: isActive
                        ? 'linear-gradient(135deg, #00bcd4, #e91e63)'
                        : 'linear-gradient(135deg, rgba(0, 188, 212, 0.1), rgba(0, 188, 212, 0.15))',
                    },
                  },
                  label: {
                    fontSize: '0.875rem',
