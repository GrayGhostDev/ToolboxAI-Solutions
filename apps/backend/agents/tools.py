...
class SearchTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="search",
            description="Search for educational content and resources"
        )
...
class GenerateTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="generate",
            description="Generate educational content based on parameters"
        )
...
class SummarizeTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="summarize",
            description="Create summaries of educational content"
        )
...
class AssessmentTool(Tool):
    ...
    def __init__(self):
        super().__init__(
            name="assessment",
            description="Create assessments and quizzes from educational content"
        )
