...
class CachedAIService:
        ...
        **kwargs
        ...
        if use_cache:
            ...
            if cached_response:
                ...
                logger.info(f"Cache hit for model {model} (similarity: {cached_response.get('similarity', 1.0)})")
        ...
        try:
            ...
            if model.startswith('gpt'):
                ...
                response = await self._call_langchain(prompt, model, temperature, max_tokens, **kwargs)
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'cache_hit_rate': self.cached_responses / max(self.total_api_calls + self.cached_responses, 1),
