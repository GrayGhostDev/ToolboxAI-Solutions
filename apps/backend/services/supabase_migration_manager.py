...
class SupabaseMigrationManager:
    ...
    def __init__(self):
        ...
        self.shadow_client: Optional[Client] = None
        self.async_conn: Optional[asyncpg.Connection] = None
    ...
    async def _load_migration_history(self):
        ...
        try:
            result = self.primary_client.table('schema_migrations')\
                .select("*")\
    ...
    def _parse_migration_file(self, file_path: Path) -> Optional[Migration]:
        ...
        for line in lines:
            if line.startswith('-- Version:'):
                ...
                metadata['maintenance'] = line.replace('-- Requires-Maintenance:', '').strip().lower() == 'true'
            ...
            for migration in migrations_to_rollback:
                try:
                    ...
                    self.primary_client.table('schema_migrations')\
                        .update({'status': MigrationStatus.ROLLED_BACK.value})\
    ...
    def _filter_migrations(self, target_version: Optional[str]) -> List[Migration]:
        """Filter migrations up to target version."""
    ...
    async def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_applied": self.applied_migrations[-1].version if self.applied_migrations else None,
