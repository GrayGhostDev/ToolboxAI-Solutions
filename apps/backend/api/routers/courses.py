...
from apps.backend.models.education import Course, Lesson, Enrollment, User, LessonProgress
from apps.backend.schemas.education import (
    CourseCreate, CourseUpdate, CourseResponse, CourseWithInstructor,
    LessonCreate, LessonUpdate, LessonResponse,
    EnrollmentCreate, EnrollmentResponse, EnrollmentWithCourse,
    PaginationParams
)
