...
class WorkerConfig:
    ...
    flower_basic_auth: str | None = os.getenv("FLOWER_BASIC_AUTH")  # user:password
    ...
    def to_celery_config(self) -> dict[str, Any]:
        ...
        config = {
            ...
            "worker_cancel_long_running_tasks_on_connection_loss": self.worker_cancel_long_running_tasks_on_connection_loss,
...
def get_queue_definitions() -> list[dict[str, Any]]:
    ...
    return [
        ...
        Queue("default", Exchange("default"), routing_key="default", priority=5, max_priority=10),
