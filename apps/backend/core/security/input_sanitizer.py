...
def get_safe_error_response(
    error: Exception, include_type: bool = False, custom_message: str | None = None
) -> dict[str, Any]:
    """
    ...
    if custom_message:
        ...
        generic_message = error_messages.get(
            type(error).__name__, "An error occurred while processing your request"
        )

    response = {"success": False, "error": generic_message}
