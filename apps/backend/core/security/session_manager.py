...
class SessionManager:
    ...
    def _get_session_redis(self, session_id: str) -> Optional[SessionInfo]:
        ...
        session_data = {
            k: v if not k.endswith('_at') and k != 'is_active' 
    ...
    def invalidate_session(self, session_id: str) -> bool:
        ...
        self._log_session_event(
            user_id=session.user_id,
            session_id=session_id,
            event=SessionEvent.INVALIDATED
        )
    ...
    def invalidate_all_user_sessions(self, user_id: str, reason: str = "manual") -> int:
        ...
        self._log_session_event(
            user_id=user_id,
            session_id="all",
            event=SessionEvent.PASSWORD_CHANGED if reason == "password_change" else SessionEvent.LOGOUT,
