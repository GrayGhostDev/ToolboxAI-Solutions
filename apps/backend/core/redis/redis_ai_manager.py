...
class RedisAIManager:
    ...
    def _initialize_vector_index(self):
        ...
        try:
            ...
            definition = IndexDefinition(prefix=[self.PREFIX_VECTOR], index_type=IndexType.HASH)

            self.redis.ft(self.vector_index_name).create_index(fields=schema, definition=definition)
    ...
    def search_similar_vectors(
        ...
        query = (
            Query(query_str)
            .sort_by("score")
            .return_fields("content", "agent_id", "type", "timestamp", "metadata", "score")
            .dialect(2)
        )
    ...
    def cache_set(self, key: str, value: Any, ttl: int = 300, namespace: str = "default") -> bool:
        """
