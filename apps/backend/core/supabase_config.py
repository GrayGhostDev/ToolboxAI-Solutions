    ...
    async def setup_realtime_subscriptions(self, callback_handlers: Dict[str, callable]):
        ...
        try:
            ...
            if 'agent_instances' in callback_handlers:
                self.client.table('agent_instances').on('*', callback_handlers['agent_instances']).subscribe()
            ...
            if 'agent_executions' in callback_handlers:
                self.client.table('agent_executions').on('*', callback_handlers['agent_executions']).subscribe()
            ...
            if 'system_health' in callback_handlers:
                self.client.table('system_health').on('*', callback_handlers['system_health']).subscribe()
