...
from .auth import get_current_user, create_user_token, authenticate_user
...
async def health_check():
    ...
    return {
        ...
        "uptime": time.time() - dashboard_app.state.start_time if hasattr(dashboard_app.state, 'start_time') else 0
    }
