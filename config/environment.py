...
class RobloxConfig:
    ...
    max_parts: int = 10000
    max_scripts: int = 100
    terrain_size_limits: dict[str, int] = field(
...
class EnvironmentConfig:
    ...
    def _init_database_configs(self):
        ...
        self.databases[DatabaseType.ROBLOX] = DatabaseConfig(
            url=os.getenv(
                "ROBLOX_DATABASE_URL",
                os.getenv("DATABASE_URL", "sqlite:///./toolboxai_roblox.db"),
            ),
            pool_size=5,
            max_overflow=10,
        )
    ...
    def _init_roblox_config(self):
        ...
        self.roblox = RobloxConfig(
            ...
            terrain_size_limits=terrain_limits
            or {"small": 200, "medium": 500, "large": 1000, "xlarge": 2000},
    ...
    def _init_feature_flags(self):
        ...
        self.features = {
            ...
            "bypass_rate_limit_in_tests": os.getenv("BYPASS_RATE_LIMIT_IN_TESTS", "true").lower()
            == "true",
    ...
    def get_database_config(
        self, db_type: Union[DatabaseType, str] = DatabaseType.EDUCATION
    ) -> DatabaseConfig:
    ...
    def use_mock_data(self) -> bool:
        ...
        return (
            ...
            or os.getenv("USE_MOCK_DATA", "false").lower() == "true"
        )
    ...
    def use_mock_database(self) -> bool:
        ...
        return (
            self.environment == Environment.TESTING
            or os.getenv("USE_MOCK_DATABASE", "false").lower() == "true"
        )
...
async def get_async_session(database: str = "education"):
    ...
    from database import get_async_session as _get_async_session
