-- Educational Platform Database Setup Script for macOS
-- PostgreSQL 16
-- 
-- This script creates the necessary databases and users for the educational platform
-- Run as PostgreSQL superuser (postgres or your macOS user)
...
-- Create development database (using macOS compatible locale)
