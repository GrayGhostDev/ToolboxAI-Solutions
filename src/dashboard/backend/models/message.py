...
class Message(Base, TimestampMixin):
    ...
    # Compatibility alias expected by some API code
    @property
    def parent_message_id(self) -> Optional[str]:
        """Alias for reply_to_id for compatibility with APIs expecting parent_message_id field"""
...
class MessageRecipient(Base, TimestampMixin):
    ...
    # Add a numeric/status alias for compatibility with APIs that expect a 'status' field
