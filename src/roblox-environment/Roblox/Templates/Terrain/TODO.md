...
-- - Walls with educational posters
...
-- - Work stations/benches placement
-- - Safety zones marked
...
4. GeographyTerrain (Medium - Subject specific)
5. HistoricalTerrain (Low - Advanced feature)
6. SpaceTerrain (Low - Advanced feature)
7. OceanTerrain (Low - Advanced feature)
8. MathVisualizationTerrain (Low - Specialized)