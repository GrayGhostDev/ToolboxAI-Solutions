...
try:
    from agents.content_agent import ContentGenerationAgent  # type: ignore
    from agents.orchestrator import OrchestrationEngine  # type: ignore
    from agents.quiz_agent import QuizGenerationAgent  # type: ignore
    from agents.review_agent import CodeReviewAgent  # type: ignore
    from agents.script_agent import ScriptGenerationAgent  # type: ignore
    from agents.supervisor import SupervisorAgent  # type: ignore
    from agents.terrain_agent import TerrainGenerationAgent  # type: ignore
    from coordinators.main_coordinator import MainCoordinator  # type: ignore
    from sparc.state_manager import SPARCStateManager  # type: ignore
...
class AgentManager:
    ...
    def __init__(self):
        ...
        self.sparc_manager = SPARCStateManager()
    ...
    async def generate_content(
        ...
        """Generate educational content using multi-agent system"""
        ...
        try:
            ...
            aggregated_result = await self.result_aggregator.aggregate_results(
                "content_generation", agent_results
            )

            # Use main coordinator for final orchestration
