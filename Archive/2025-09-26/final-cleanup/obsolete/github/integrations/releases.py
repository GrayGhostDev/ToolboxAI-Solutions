...
- 🐛 Issues: [GitHub Issues](https://github.com/ToolBoxAI-Solutions/ToolboxAI-Roblox/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/ToolBoxAI-Solutions/ToolboxAI-Roblox/discussions)
- 📧 Email: support@toolboxai.solutions

---

**Full Changelog**: https://github.com/ToolBoxAI-Solutions/ToolboxAI-Roblox/compare/v{self._get_previous_version(version)}...{version}
...
- Documentation: docs/
- GitHub Release: https://github.com/ToolBoxAI-Solutions/ToolboxAI-Roblox/releases/tag/v{version}
